...
-- 2025.08.15  
-- ZCCU  
CREATE FUNCTION [dbo].[fduCAAsignaEtapaCredito_IFRS9_xMes] (@CodPrestamo VARCHAR(35),@Fecha SMALLDATETIME)       
RETURNS varchar(2000)        
AS  
BEGIN  
-------------------PRUEBAS   
--DECLARE @CodPrestamo VARCHAR(30)  
--SET @CodPrestamo = '005-170-06-08-10824'  
  
--DECLARE @Fecha SMALLDATETIME  
--SET @Fecha = '2025-11-17 00:00:00'--'20250820'  
----------------------------  
...
WHERE Fecha IN (SELECT UltimoDia from tclperiodo with(nolock))  
