...
GO
CREATE FUNCTION [dbo].[fduFormatoHoraM] (@TiempoEstimado float)  
RETURNS Varchar(50)
AS  
BEGIN 
	...
	Set @Hora 	= 	CAST(@TiempoEstimado / 3600000 AS int) 
	Set @Minuto 	= 	Cast(((@TiempoEstimado / 3600000) - CAST(@TiempoEstimado / 3600000 AS int)) * 60 as Int)--CAST(@TiempoEstimado / 60 AS int) 
	Set @Segundo 	= 	CAST((@TiempoEstimado / 60000 - CAST(@TiempoEstimado / 60000 AS int)) * 60 AS int)
