...
*/
CREATE Procedure [dbo].[pCsCaDesembolsosRecuperaciones3]
	@Dato		Int,
...
Set CA = ( case when tCsCartera.NroCuotas - tCsCartera.NroCuotasPagadas=0 then 0 else
	            (tCsCartera.SaldoCapital + tCsCartera.SaldoInteresCorriente + tCsCartera.SaldoINVE + tCsCartera.SaldoINPE 
	            + tCsCartera.CargoMora + tCsCartera.OtrosCargos + tCsCartera.Impuestos)
						   / (tCsCartera.NroCuotas - tCsCartera.NroCuotasPagadas)
						   end
						) * (tCsCartera.CuotaActual - tCsCartera.NroCuotasPagadas), 
		ConsultaPago = 'PAGADO'
...
--						   / (tCsCartera.NroCuotas - tCsCartera.NroCuotasPagadas)) * (tCsCartera.CuotaActual - tCsCartera.NroCuotasPagadas)
	Set CA = (case when tCsCartera.NroCuotas - tCsCartera.NroCuotasPagadas=0 then 0 else 
	          (tCsCartera.SaldoCapital + tCsCartera.SaldoInteresCorriente + tCsCartera.SaldoINVE + tCsCartera.SaldoINPE + tCsCartera.CargoMora + tCsCartera.OtrosCargos + tCsCartera.Impuestos)
						/ (tCsCartera.NroCuotas - tCsCartera.NroCuotasPagadas)
						end
						) * (tCsCartera.CuotaActual - tCsCartera.NroCuotasPagadas)
	FROM         tCsCartera INNER JOIN
...
Begin
	...
	Set @Cadena	= @Cadena + '(case when tCsCartera.NroCuotas - tCsCartera.NroCuotasPagadas=0 then 0 else (tCsCartera.SaldoCapital + tCsCartera.SaldoInteresCorriente + tCsCartera.SaldoINVE + tCsCartera.SaldoINPE + '
	Set @Cadena	= @Cadena + 'tCsCartera.CargoMora + tCsCartera.OtrosCargos + tCsCartera.Impuestos) / (tCsCartera.NroCuotas - tCsCartera.NroCuotasPagadas) end)* '
