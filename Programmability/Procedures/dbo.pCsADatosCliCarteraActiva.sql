...
--pCsADatosCliCarteraActiva
--pCsADatosCliCarteraActivaDatos '20181231',''
----create procedure pCsADatosCliCarteraActivaDatos  @fecha smalldatetime,@codoficina varchar(4)
----as
----	select * from tCsADatosCliCarteraActiva
CREATE procedure [dbo].[pCsADatosCliCarteraActiva]
as
set nocount on
...
truncate table tCsADatosCliCarteraActiva

insert into tCsADatosCliCarteraActiva
