...
--select * from tCoClPonderacionActivo

CREATE PROCEDURE [dbo].[pCoObtieneRepoActivoPondCns](
...
--		exec pCoObtieneSaldoCta @CodCta, @CodFondo, @Fecha, @SaldoCta output , @SaldoCtaMes output
		exec pCoObtieneSaldoCtaCns @CodCta, @CodFondo, @Fecha, @SaldoCta output , @SaldoCtaMes output
