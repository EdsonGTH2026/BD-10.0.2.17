...
CREATE Procedure [dbo].[pCsReportD_CAsaldoCubetasVs2] @fecha smalldatetime      
as      
BEGIN  
...
----- version que no incluye c16a30dm, si no el desgloce c16a21dm y c22a30dm        ---- Sil  18.02.2025
SELECT * FROM FNMGCONSOLIDADO.DBO.TmpROCAsaldoCubetas WITH(NOLOCK)
WHERE FECHA=@fecha
and Cubetas not in ('c16a30dm')    
