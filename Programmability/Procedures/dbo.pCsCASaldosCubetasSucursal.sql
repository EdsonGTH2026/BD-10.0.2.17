...
GO
--pCsCASaldosCubetasSucursal
CREATE procedure [dbo].[pCsCASaldosCubetasSucursal]
as
set nocount on
...
truncate table tCsACaSaldosCubSucursal 

insert into tCsACaSaldosCubSucursal
...
--into tCsACaSaldosCubSucursal
from (
  SELECT o.nomoficina sucursal,c.Fecha, c.cartera tipo
