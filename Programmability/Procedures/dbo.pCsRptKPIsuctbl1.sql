...
create procedure [dbo].[pCsRptKPIsuctbl1] @fecha smalldatetime, @codoficina varchar(5)  
as     
set nocount on   
...
declare @cobranza table ( codoficina varchar(5),nomoficina varchar(30) ,rangoCiclo VARCHAR(20)         
