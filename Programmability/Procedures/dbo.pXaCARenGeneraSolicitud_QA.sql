...
GO
CREATE procedure [dbo].[pXaCARenGeneraSolicitud_QA] @CodSolicitud varchar(20), @CodOficina varchar(4)
as
	...
	from [10.0.2.14].finmas_20190522ini.dbo.tcasolicitud s
	inner join [10.0.2.14].finmas_20190522ini.dbo.tCaSolicitudApp a on s.codsolicitud=a.codsolicitud and s.codoficina=a.codoficina
	left outer join [10.0.2.14].finmas_20190522ini.dbo.tCaSolicitudproce p on s.codsolicitud=p.codsolicitud and s.codoficina=p.codoficina
	...
	begin
		...
		insert into #tmp
		exec [10.0.2.14].finmas_20190522ini.dbo.pCaCrearSolicitudRenovacionCiclo @CodSolicitud,@CodOficina  --prodccion
	
		insert into [10.0.2.14].finmas_20190522ini.dbo.tcasolicitudapp  --prodccion
