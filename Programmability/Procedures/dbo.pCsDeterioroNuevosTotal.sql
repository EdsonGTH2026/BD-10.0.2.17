...
GO
----DETERIORO C1 desglosado por sucursal
----antigüedad semanas 4-16 (12 semanas evaluadas)

CREATE procedure [dbo].[pCsDeterioroNuevosTotal]  with encryption
as  
SET NOCOUNT ON  
BEGIN
...
GRANT EXECUTE ON [dbo].[pCsDeterioroNuevosTotal] TO [rie_jalvarezc]
GO

GRANT EXECUTE ON [dbo].[pCsDeterioroNuevosTotal] TO [int_ltorresa]
GO