...
GO
--sp_helptext [pCsCACobPuntualReOpera]-- @fecha,@fecini --- se ajusta para correr a fechas pasadas. ZCCU               
  
CREATE procedure [dbo].[pCsCACobPuntualReOpera] @fecha smalldatetime, @fecini smalldatetime      
as   
set nocount on      
