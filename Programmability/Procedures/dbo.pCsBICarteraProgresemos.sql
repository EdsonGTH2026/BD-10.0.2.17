...
GO
CREATE procedure [dbo].[pCsBICarteraProgresemos] 
as

--sp_helptext 
--exec [pCsBICarteraProgresemos]
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso=0 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end )  else 0 end else 0 end D0saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>0 and c.NroDiasAtraso<=7 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D1a7saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=8 and c.NroDiasAtraso<=15 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D8a15saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=16 and c.NroDiasAtraso<=30 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D16a30saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=31 and c.NroDiasAtraso<=60 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D31a60saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=61 and c.NroDiasAtraso<=89 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D61a89saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=90 and c.NroDiasAtraso<=120 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D90a120saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=121 and c.NroDiasAtraso<=150 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end) else 0 end else 0 end D121a150saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=151 and c.NroDiasAtraso<=180 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D151a180saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=181 and c.NroDiasAtraso<=210 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D181a210saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=211 and c.NroDiasAtraso<=240 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end D211a240saldo
...
,case when c.cartera<>'CASTIGADA' then case when c.NroDiasAtraso>=241 then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end else 0 end Dm241infsaldo
,case when c.cartera='CASTIGADA' then cd.codprestamo else null end Castigadonroptmo
,case when c.cartera='CASTIGADA' then (case when c.codfondo=20 then cd.saldocapital*0.70 else 0 end)  else 0 end Castigadosaldo
