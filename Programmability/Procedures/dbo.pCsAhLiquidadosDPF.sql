...
GO
CREATE PROCEDURE  [dbo].[pCsAhLiquidadosDPF] @fecI smalldatetime, @fecF smalldatetime
as
...
--set @fecF='20170112'
	...
	where a.estadocalculado='CC'
	and a.feccancelacion>=@fecI and a.feccancelacion<=@fecF
GO

GRANT EXECUTE ON [dbo].[pCsAhLiquidadosDPF] TO [jarriagaa]
GO