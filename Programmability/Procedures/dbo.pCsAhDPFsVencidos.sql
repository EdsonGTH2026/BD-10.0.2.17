...
GO
CREATE PROCEDURE  [dbo].[pCsAhDPFsVencidos]
as
	...
	WHERE a.Fecha=@Fecha   AND  a.idEstadoCta <> 'cc' and a.FechaVencimiento<=@Fecha
GO

GRANT EXECUTE ON [dbo].[pCsAhDPFsVencidos] TO [jarriagaa]
GO