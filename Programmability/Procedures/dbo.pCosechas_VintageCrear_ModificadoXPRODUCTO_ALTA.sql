...
GO
CREATE PROCEDURE [dbo].[pCosechas_VintageCrear_ModificadoXPRODUCTO_ALTA] (@Ubicacion Varchar(100), @ClaseCartera Varchar(100), @producto varchar(5))
AS
...
--SET @CUbicacion = (SELECT SUBSTRING(@CUbicacion,1,218)+ ', 98') --se cambo porque marcaba error
SET @CUbicacion = @CUbicacion +  ', 0'
