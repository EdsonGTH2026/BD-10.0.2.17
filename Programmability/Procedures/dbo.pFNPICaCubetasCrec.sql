...
----set @codoficina='15,21,3,301,302,303,304,307,308,309,310,311,315,318,320,321,322,323,324,325,326,327,33,330,332,333,334,335,336,337,339'+  
----',341,342,344,37,4,41,431,432,433,434,435,436,438,439,441,442,447,448,452,453,454,455,456,457,458,459,460,461,462,5,501,6,8,999,25,28'  
----exec pFNPICaCubetasCrec @codoficina  

CREATE procedure [dbo].[pFNPICaCubetasCrec] @codoficina varchar(2000)  
as  
set nocount on  
...
--------------AJUSTAR FECHA INICIAL @fecini POR: COMO FINALIZA LA CARTERA EL ULTIMO DOMINGO.---ZCCU 2024.06.25
