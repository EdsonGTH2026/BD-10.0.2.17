...
GO
----exec pCsCuadroCAAHFechas '20171101','20171130'
----drop procedure pCsCuadroCAAHFechas
CREATE procedure [dbo].[pCsCuadroCAAHFechasVs2] @fecini2 smalldatetime,@fecfin2 smalldatetime
as
set nocount on
--declare @fecini2 datetime
--declare @fecfin2 datetime
...
select 11 item,'Cartera Pasiva mayor a 2000000 mil' descripcion union
...
select 16 item,'Cartera Pasiva menor a 2000000 mil' descripcion union
...
,@m2=sum(case when SaldoCuenta>=2000000 then SaldoCuenta else 0 end) --ma500
,@m3=sum(case when SaldoCuenta<2000000 then SaldoCuenta else 0 end) --me500
from tcsahorros
...
,@m2=sum(case when montototaltran>=2000000 then montototaltran else 0 end) --ma500
,@m3=sum(case when montototaltran<2000000 then montototaltran else 0 end) --me500
...
@m1 = sum(case when cta.codusuario is null then 
					case when a.saldocuenta>=2000000 then a.saldocuenta else 0 end
				else 0 end) --ahnuevo
...
GRANT EXECUTE ON [dbo].[pCsCuadroCAAHFechasVs2] TO [marista]
GO