...
CREATE PROCEDURE [dbo].[pCsAhEstadoCuenta] @Usuario VARCHAR(20), @Cuenta VARCHAR(25),@fraccioncta varchar(3),@renovado int, @PrimerCorte SMALLDATETIME, @UltimoCorte SMALLDATETIME    
AS    
