...
GO
/*TENDENCIA DE SALDO CAPITAL POR REGIONES Y SUCURSALES_20220726*/  
  
CREATE procedure [dev_cchavezd].[TendenciaSaldoprueba1]    @fecha smalldatetime,@meses int  
as   
set nocount on  
...
--declare @meses int  
--set @meses= 6--mostrar el # de meses ingresado  
...
--where sucursal='San Andres Tuxtla' 
