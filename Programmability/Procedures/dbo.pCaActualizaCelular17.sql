...
GO
create procedure [dbo].[pCaActualizaCelular17] @codusuario varchar(15), @nrocelular varchar(10)
as
...
*/
exec [10.0.2.14].finmas.dbo.pCaActualizaCelular @codorigen,@nrocelular
