...
GO
create procedure [dbo].[pCsCaRptLiqRenoReacSucursales] @codoficina varchar(2000)
as
set nocount on

--declare @codoficina varchar(2000)
--set @codoficina='114,122,123,126,144,15,158,159,21,25,28,322,323,326,33,344,433'
