...
CREATE procedure [dev_cchavezd].[pCsCaIncOrgP1x_vs2] @fecha smalldatetime    
as    
set nocount on    
...
select codoficina,codasesor,coordinador,saldocapital,categoria, 0 BonoObjetivo--,FechaIngreso   
--,FechaIngreso,mes  
--,desembolso,pordeudese   

--/*cambio solicitado por Miriam*/
