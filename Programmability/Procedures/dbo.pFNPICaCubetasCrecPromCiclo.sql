...
GO
----exec pFNPICaCubetasCrecPromCiclo 'SRJ910416M0416',2
CREATE procedure [dbo].[pFNPICaCubetasCrecPromCiclo] @codasesor varchar(15), @ciclo int
as
set nocount on
...
from FNMGConsolidado.dbo.tCACubetasxPromCiclo with(nolock)
where fecha=@fecini
and promotor=@codasesor
...
begin
	...
	,0 Vig0a30saldo,0 Atr31a89saldo,0 Ven90msaldo,0 Imor30,0 Imor60,0 Imor90
...
,a.Vig0a30saldo-b.Vig0a30saldo,a.Atr31a89saldo-b.Atr31a89saldo,a.Ven90msaldo-b.Ven90msaldo,a.Imor30-b.Imor30,a.Imor60-b.Imor60,a.Imor90-b.Imor90
