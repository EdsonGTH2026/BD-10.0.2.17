...
GO
CREATE procedure [dbo].[pFMKDatosCobranzaMasiva_ParaCliente] @fecha smalldatetime, @ControlInterno varchar(20), @CodUsuario varchar(20), @CodUsuarioCobranza varchar(20)
as
