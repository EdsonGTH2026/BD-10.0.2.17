...
CREATE procedure [dbo].[pCsRegAhorroxMunSiti] @fec smalldatetime      
as      
...
GRANT EXECUTE ON [dbo].[pCsRegAhorroxMunSiti] TO [rie_sbravoa]
GO

GRANT EXECUTE ON [dbo].[pCsRegAhorroxMunSiti] TO [rie_ldomingueze]
GO

GRANT EXECUTE ON [dbo].[pCsRegAhorroxMunSiti] TO [rie_jalvarezc]
GO