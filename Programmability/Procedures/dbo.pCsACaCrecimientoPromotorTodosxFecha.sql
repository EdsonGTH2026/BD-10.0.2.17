...
GO
CREATE procedure [dbo].[pCsACaCrecimientoPromotorTodosxFecha] @fecha smalldatetime
as
	set nocount on

	--truncate table tCsACrecimientoPromotor
	delete from FNMGConsolidado.dbo.CaCreco where fecha=@fecha
	...
	begin
		...
		--print @codoficina
		exec pCsACaCrecimientoPromotorxFecha @fecha,@codoficina
		--print @x
		set @x=@x+1
	end
...
GRANT EXECUTE ON [dbo].[pCsACaCrecimientoPromotorTodosxFecha] TO [marista]
GO