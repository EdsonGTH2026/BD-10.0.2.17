...
GO
----exec pFNPICaCubetasCrecProm 'BDG980505F5MF1'

CREATE procedure [dbo].[pFNPICaCubetasCrecProm] @codasesor varchar(15)
as
...
from FNMGConsolidado.dbo.tCACubetasxProm with(nolock)
where fecha=@fecini
