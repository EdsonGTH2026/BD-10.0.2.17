...
/*TENDENCIA DE SALDO CAPITAL-MISMO DIA  IMOR NACIONAL*/

CREATE procedure [dbo].[pCsRepTendenciaSaldoT5]  @fecha smalldatetime,@meses int  
as   
set nocount on  


--declare @fecha smalldatetime  ---LA FECHA DE CORTE  
--select @fecha='20220725'--fechaconsolidacion from vcsfechaconsolidacion 
