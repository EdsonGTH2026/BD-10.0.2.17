...
GO
CREATE procedure [dbo].[pCsAhAhorrosxCubetas] @fecha smalldatetime
as
...
,count(distinct(case when substring(a.codcuenta,5,1)=2 then (case when a.plazo>=181 then a.codusuario else null end) else null end)) cpnroclim180
,count(distinct(case when substring(a.codcuenta,5,1)=2 then (case when a.plazo>=181 then a.codcuenta else null end) else null end)) cpnroctam180
,sum(case when substring(a.codcuenta,5,1)=2 then (case when a.plazo>=181 then a.saldocuenta + a.intacumulado else 0 end) else 0 end) cpsaldocuentam180
