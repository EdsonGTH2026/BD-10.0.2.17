...
SET ANSI_NULLS OFF
GO
CREATE PROCEDURE [dbo].[pCsRptCaCarteraVigilancia] @fecha smalldatetime AS
--declare @fecha smalldatetime
--set @fecha ='20131027'

select fecha,tipo,sucursal,count(distinct codusuario) nroclie, count(distinct codprestamo) nroptmo
...
and c.codoficina in ('28','11','31','18','7','15','12','19','32','35','24','17','3','36')
) a
group by fecha,tipo,sucursal
GO