...
SET ANSI_NULLS OFF
GO
CREATE procedure [dbo].[pCsRptCaCarteraxProdxReg] @fecha smalldatetime
as
--declare @fecha smalldatetime
--set @fecha='20140630'

select region,codproducto,producto
...
from (
  SELECT rtrim(ltrim(z.zona)) + ' ' + z.nombre region,pc.codproducto
...
group by region,codproducto,producto
GO