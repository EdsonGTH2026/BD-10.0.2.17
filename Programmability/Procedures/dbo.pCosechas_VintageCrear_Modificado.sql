...
GO
create procedure [dbo].[pCosechas_VintageCrear_Modificado] ( @Ubicacion Varchar(100), @ClaseCartera Varchar(100))
as
...
IF @Ubicacion = 'ZZZ'
BEGIN
Exec pGnlCalculaParametros2 1, @Ubicacion, 		@CUbicacion 	Out, 	@Ubicacion 		Out,  @OtroDato Out
Exec pGnlCalculaParametros2 2, @ClaseCartera, 	@CClaseCartera 	Out, 	@ClaseCartera 	Out,  @OtroDato Out
