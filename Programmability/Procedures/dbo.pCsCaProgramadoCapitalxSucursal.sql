...
--CREATE procedure pCsCaProgramadoCapitalxPromotor @fecha smalldatetime
--as
CREATE procedure [dbo].[pCsCaProgramadoCapitalxSucursal] @fecha smalldatetime,@codoficina varchar(2000)
as
