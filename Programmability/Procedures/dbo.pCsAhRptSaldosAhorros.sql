...
GO
CREATE PROCEDURE [dbo].[pCsAhRptSaldosAhorros]  @Fecha smalldatetime  AS
SELECT     REPLICATE('0', 2 - DATALENGTH(tClOficinas.CodOficina)) + tClOficinas.CodOficina + ' ' + tClOficinas.NomOficina AS Oficina, 
                      ...
                      SUM(tCsAhorros.IntAcumulado) AS SaldoInt, tAhClTipoProducto.DescTipoProd
...
GROUP BY tClOficinas.NomOficina, tAhClTipoProducto.DescTipoProd, tClOficinas.CodOficina
