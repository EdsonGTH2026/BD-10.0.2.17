...
GO
CREATE procedure [dbo].[pCsRptCaAfectanPorOficina] (@codoficina varchar(3))
as
...
where 
b.Desembolso>='20140101' 
and b.codproducto not in(167,168)
...
and c.nrodiasatraso>=4 and c.nrodiasatraso<=59 
--and c.codoficina=@codoficina
and (c.codoficina=@codoficina or c.codoficina=@codoficina2)
