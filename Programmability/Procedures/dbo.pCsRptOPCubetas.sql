...
GO
create procedure [dbo].[pCsRptOPCubetas] @fecha smalldatetime
as
--SALDOS POR CUBETA POR: FODEADOR, TOTAL, REGION, SUCURSAL, CICLO --
...
--,secuenciacliente  --HABILITAR PARA OBTENERLO POR CICLOS--
...
,count(distinct D90a120nroptmo) D90a120nroptmo
,sum(D90a120saldo) D90a120saldo
,count(distinct D121a150nroptmo) D121a150nroptmo
,sum(D121a150saldo) D121a150saldo
,count(distinct D151a180nroptmo) D151a180nroptmo
,sum(D151a180saldo) D151a180saldo
,count(distinct D181a210nroptmo) D181a210nroptmo
,sum(D181a210saldo) D181a210saldo
,count(distinct D211a240nroptmo) D211a240nroptmo
...
--  and c.codprestamo in(select codprestamo from #ptmos2)
 ...
 group by region--, nomoficina--, secuenciacliente
