...
GO
CREATE procedure [dbo].[pFMKDatosCobranzaMasivaMenor60_ParaOficinaUsuario] @fecha smalldatetime, @ControlInterno varchar(20),@CodOficina varchar(3), @CodUsuarioCobranza varchar(15)
as
/*
...
where c.fecha=@fecha and c.nrodiasatraso>0 and c.nrodiasatraso<=100
