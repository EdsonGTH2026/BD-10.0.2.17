...
CREATE Procedure [dbo].[pCsRptCaSituacionCarteraVerticalNoel]
    @Dato			Int,
    @Fecha 			SmallDateTime,
...
print '@ubicacion ' + @ubicacion + ' - ' + @CUbicacion
...
Print '@TempI : ' + cast(Isnull(@TempI, 0) as varchar)

print @fecha
print 'datepart: ' + dbo.fduNumeroALetras(DATEPART(Day, @Fecha), 0)
