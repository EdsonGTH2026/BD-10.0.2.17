...
GO
CREATE procedure [dbo].[pCsAhReprocesaAhorroVistaMes] @codcuenta varchar(25)--,@fraccioncta varchar(5),@renovado int
as
set nocount on
--declare	@codcuenta varchar(25)
--set @codcuenta='021-106-06-2-5-00052'--'002-102-06-2-0-00313'
