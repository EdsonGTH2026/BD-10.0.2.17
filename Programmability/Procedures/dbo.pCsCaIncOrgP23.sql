...
GO
CREATE procedure [dbo].[pCsCaIncOrgP23] @fecha smalldatetime
as
set nocount on
...
,case	when Imor30>=0 and Imor30<=3 then 5
		...
		when Imor30>15 then 0 else 0 end puntos
from (
