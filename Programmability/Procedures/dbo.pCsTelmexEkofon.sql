...
GO
CREATE PROCEDURE [dbo].[pCsTelmexEkofon] @fecIni smalldatetime, @fecFin smalldatetime , @CodOficina varchar(200) AS
SELECT DISTINCT  t.nrotransaccion,t.Fecha, tClOficinas.NomOficina, t.TipoTransacNivel1,  
...
(t.TipoTransacNivel3 in(1,6,11,13,18,19,21,22,23)) 
order by nomoficina
GO