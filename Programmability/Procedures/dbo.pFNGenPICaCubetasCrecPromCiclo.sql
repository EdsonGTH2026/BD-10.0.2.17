...
CREATE procedure [dbo].[pFNGenPICaCubetasCrecPromCiclo]
as
set nocount on
--declare @T1 datetime
--declare @T2 datetime
...
delete from FNMGConsolidado.dbo.tCACubetasxPromCiclo where fecha=@fecha

insert into FNMGConsolidado.dbo.tCACubetasxPromCiclo
...
group by codoficina,promotor,ciclo
