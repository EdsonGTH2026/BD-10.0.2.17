...
SET ANSI_NULLS OFF
GO
CREATE procedure [dbo].[pCsRptCaCarteraxTipxReg] @fecha smalldatetime
as
--declare @fecha smalldatetime
--set @fecha='20131215'

select fecha,tipo,region,count(distinct codusuario) nroclie, count(distinct codprestamo) nroptmo
