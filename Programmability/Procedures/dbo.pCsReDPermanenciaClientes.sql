...
CREATE procedure [dbo].[pCsReDPermanenciaClientes]  @fecha smalldatetime  
as  
set nocount on   
...
SELECT * FROM FNMGCONSOLIDADO.DBO.TmpROCAPermaClientes WITH(NOLOCK)
...
--and pc.SecuenciaCliente = 1 AND pc.CodOficina <> '999' and pc.CodOficina <> '231'  
...
-- group by fechacorte,cosechaGeneracion,añoGeneracion  
