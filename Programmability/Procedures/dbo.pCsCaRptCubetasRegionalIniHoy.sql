...
GO
CREATE procedure [dbo].[pCsCaRptCubetasRegionalIniHoy] @codoficina varchar(2000)
as
set nocount on
...
insert into #cu
(fecha,region,ini_nroptmo,ini_saldocapital,ini_VigenteNro,ini_VigenteSaldo,ini_VigentePor,ini_AtrasoNro,ini_AtrasoSaldo,ini_AtrasoPor,ini_VencidoNro,ini_VencidoSaldo,ini_VencidoPor)
select @fecha fecha,region
...
from #cu c
inner join #hoy h on c.region=h.region
