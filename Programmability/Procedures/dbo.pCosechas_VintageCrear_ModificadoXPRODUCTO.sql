...
GO
CREATE PROCEDURE [dbo].[pCosechas_VintageCrear_ModificadoXPRODUCTO] (@Ubicacion Varchar(100), @ClaseCartera Varchar(100), @producto varchar(5))
AS
