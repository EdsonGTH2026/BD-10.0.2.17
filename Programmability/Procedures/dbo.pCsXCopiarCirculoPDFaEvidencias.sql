...
create procedure [dbo].[pCsXCopiarCirculoPDFaEvidencias] (@RutaArchivoOrigen varchar(150), @CodOficina varchar(3), @CodSolicitud varchar(20), @IdTipoDocumento int, @Resultado varchar(10) output)
as
BEGIN
	set nocount off
	...
	*/
	...
	select @RutaOrigen = valor from [10.0.2.14].FinamigoSIC.dbo.tCCParametros where activo = 1 and tipo = 'OrigenPDF'
