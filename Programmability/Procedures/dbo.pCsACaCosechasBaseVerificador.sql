...
GO
CREATE procedure [dbo].[pCsACaCosechasBaseVerificador]
as
--truncate table tCsACaCosechasBaseVerificador
--insert into tCsACaCosechasBaseVerificador
--select t3.codverificadorData,t3.Trimestre,
