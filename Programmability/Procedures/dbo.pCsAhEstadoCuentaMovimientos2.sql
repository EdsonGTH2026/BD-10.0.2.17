...
GO
CREATE Procedure [dbo].[pCsAhEstadoCuentaMovimientos2] @Cuenta Varchar(25),@fraccioncta varchar(3), @renovado int,@Inicio SmallDateTime,@Fin SmallDateTime    
As    
set nocount on   
---------------------------------PRUEBAS 
...
----set @Cuenta='098-105-06-2-2-00243'--'098-105-06-2-7-00192'    
----set @fraccioncta='0'    
----set @renovado=0    
----set @Inicio = '20250101'    
----set @Fin = '20250131'    
...
WHERE (t.Fecha>=@Inicio) AND (t.Fecha<=@Fin) AND (t.CodSistema='AH') 
