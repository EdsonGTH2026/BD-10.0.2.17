...
GO
--exec pUsCACarteraActiva '20181231'
CREATE procedure [dbo].[pUsCACarteraActiva] @fecha smalldatetime
as
set nocount on
...
GRANT EXECUTE ON [dbo].[pUsCACarteraActiva] TO [marista]
GO