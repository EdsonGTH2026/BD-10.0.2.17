...
GO
--SP_HELPTEXT pAhRptCtesPatmir                        
--DROP PROC pAhRptCtesPatmir                        
--EXEC pAhRptCtesPatmir '2012-10-01','2012-10-31'          
CREATE PROCEDURE [dbo].[pAhRptCtesPatmir] (@FecIni SMALLDATETIME, @FecFin SMALLDATETIME)                        
    AS               
