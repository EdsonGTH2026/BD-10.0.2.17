...
GO
CREATE procedure [dbo].[pFMKDatosCobranzaMasivaPorVencer_ProdVivienda] @fecha smalldatetime, @ControlInterno varchar(20), @DiasPorVencer integer, @CodUsuarioCobranza varchar(15)
as
/*
...
and c.codprestamo in (select codprestamo from [10.0.2.14].finmas.dbo.tcaprestamos where codproducto = 168)
