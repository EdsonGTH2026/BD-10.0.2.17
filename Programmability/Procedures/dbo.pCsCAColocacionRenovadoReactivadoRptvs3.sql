...
GO
CREATE procedure [dbo].[pCsCAColocacionRenovadoReactivadoRptvs3] @fecfin smalldatetime  
as  
...
begin  
 ...
 insert into #co  
 exec pCsCAColocacionRenovadoReactivadovs3 @fecini_t,@fecfin_t  
...
select periodo,montototal,nrototal,renovadomonto,renovadomontoAnticipa,renovadomontoAnticipaAuto,renovadomontoAnticipaAPP,renovadonro,reactivadomonto,reactivadonro,montototal-renovadomonto-renovadomontoAnticipa-reactivadomonto nuevo  
,renovadoActivo,renovadohuerfano,renovadoReasignado,reactivadoActivo,reactivadohuerfano,reactivadoReasignado  
into #cx  
from #co  
  
insert into #cx(periodo,montototal,renovadomonto,renovadomontoAnticipa,renovadomontoAnticipaAuto,renovadomontoAnticipaAPP,reactivadomonto,nuevo,renovadoActivo,renovadohuerfano,renovadoReasignado,reactivadoActivo,reactivadohuerfano,reactivadoReasignado)  
select 'Promedio' Titulo,avg(montototal) montototal,avg(renovadomonto) renovadomonto,avg(renovadomontoAnticipa) renovadomontoAnticipa,AVG(renovadomontoAnticipaAuto),AVG(renovadomontoAnticipaAPP),avg(reactivadomonto) reactivadomonto,avg(nuevo) nuevo  
...
truncate table #co  
insert into #co  
exec pCsCAColocacionRenovadoReactivadovs3 @feciniMax,@fecfinMax  
  
insert into #cx  
select 'x'+periodo,montototal,nrototal,renovadomonto,renovadomontoAnticipa,renovadomontoAnticipaAuto,renovadomontoAnticipaAPP,renovadonro,reactivadomonto,reactivadonro,montototal-renovadomonto-renovadomontoAnticipa-reactivadomonto nuevo  
,renovadoActivo,renovadohuerfano,renovadoReasignado,reactivadoActivo,reactivadohuerfano,reactivadoReasignado  
from #co  
