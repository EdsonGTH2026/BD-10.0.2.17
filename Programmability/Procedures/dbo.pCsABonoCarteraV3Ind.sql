...
create procedure [dbo].[pCsABonoCarteraV3Ind]	@fecha SMALLDATETIME
as
...
--,CEILING(isnull(MCN.valorprog,0)/2)+CEILING(isnull(MCR.valorprog,0)/2) MCT--> aqui
--,CEILING(isnull(MCD.valorprog,0)/2) MCD--> aqui
,isnull(MCN.valorprog,0)+isnull(MCR.valorprog,0) MCT--> aqui
,isnull(MCD.valorprog,0) MCD--> aqui
