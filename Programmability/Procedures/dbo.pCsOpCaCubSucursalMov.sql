...
CREATE procedure [dbo].[pCsOpCaCubSucursalMov] @zona varchar(5)
as
set nocount on--off
...
select 1 orden,* from #cubeta
union
select 2 orden,* from #cubeta2
union
select 3 orden,'comparativo' tabla,c2.fecha,c2.sucursal,c2.nroptmo-c1.nroptmo nroptmototal,c2.saldocapital-c1.saldocapital saldocapitaltotal, c2.D0nroptmo-c1.D0nroptmo D0nrototal,c2.D0saldo-c1.D0saldo D0saldototal,c2.D1a7nroptmo-c1.D1a7nroptmo D1a7nrototal,c2.D1a7saldo-c1.D1a7saldo D1a7saldototal,c2.D8a15nroptmo-c1.D8a15nroptmo D8a15nrototal,c2.D8a15saldo-c1.D8a15saldo D8a15saldototal,
c2.D16a20nroptmo-c1.D16a20nroptmo D16a20nrototal,c2.D16a20saldo-c1.D16a20saldo D16a20saldototal,
c2.D21a30nroptmo-c1.D21a30nroptmo D21a30nrototal,c2.D21a30saldo-c1.D21a30saldo D21a30saldototal,
...
c2.D90a120nroptmo-c1.D90a120nroptmo D90a120nrototal,c2.D90a120saldo-c1.D90a120saldo D90a120saldototal,
c2.D121a239nroptmo-c1.D121a239nroptmo D121a239nrototal,c2.D121a239saldo-c1.D121a239saldo D121a239saldototal,
c2.D240nroptmo-c1.D240nroptmo D240nrototal,c2.D240saldo-c1.D240saldo D240saldototal,
c2.DM31imor-c1.DM31imor DM31imortotal
from #cubeta2 c2
