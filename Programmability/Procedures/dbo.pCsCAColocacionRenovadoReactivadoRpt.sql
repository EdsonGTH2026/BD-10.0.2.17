...
GO
CREATE procedure [dbo].[pCsCAColocacionRenovadoReactivadoRpt] @fecfin smalldatetime
as
...
truncate table #co
insert into #co
exec pCsCAColocacionRenovadoReactivado @feciniMax,@fecfinMax

insert into #cx
select 'x'+periodo,montototal,nrototal,renovadomonto,renovadonro,reactivadomonto,reactivadonro,montototal-renovadomonto-reactivadomonto nuevo
,renovadoActivo,renovadohuerfano,renovadoReasignado,reactivadoActivo,reactivadohuerfano,reactivadoReasignado
from #co
