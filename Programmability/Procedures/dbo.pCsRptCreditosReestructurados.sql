...
GO
--EXEC pCsRptCreditosReestructurados '20120501','20130430'  
--DROP PROC pCsRptCreditosReestructurados  
CREATE PROCEDURE [dbo].[pCsRptCreditosReestructurados]  
...
SELECT DISTINCT r.CodOficina, r.NomOficina, r.Fecha, r.MontoDesembolso, r.Cuenta, r.Nombre, r.Moneda, r.Estado, r.CodAnterior, r.CodSolicitud,  
       ...
       CASE WHEN d.FechaPago IS NULL 
            THEN case When d.DiasAtrCuota > 0 
                      then 'Atrasada' else ' ' end ELSE 'Pagada' END AS Estatus, d.FechaPago, d.DiasAtrCuota     
  FROM #CredReest r    
