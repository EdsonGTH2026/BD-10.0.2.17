...
GO
 --------pFNGenPICaCubetasCrec '98,15,21,3,301,101,302,102,303,103,304,104,307,107,308,108,309,109,310,110,311,111,315,115,317,117,318,118,319,119,320,120,321,121,322,122,323,123,324,124,325,125,326,126,327,127,329,129,33,330,130,332,132,333,133,334,134,3

-----GENERA INFORMACION A UNA FEHA ESPECIFICA, DIAS ANTERIORES 

CREATE procedure [dbo].[pFNGenPICaCubetasCrecHistorico]  @FECHA SMALLDATETIME
as   
set nocount on  
--declare @T1 datetime  
--declare @T2 datetime  
...
delete from FNMGConsolidado.dbo.tCACubetasxSuc where fecha=@fecha  
  
insert into FNMGConsolidado.dbo.tCACubetasxSuc  
...
--into FNMGConsolidado.dbo.tCACubetasNac  
from (  
