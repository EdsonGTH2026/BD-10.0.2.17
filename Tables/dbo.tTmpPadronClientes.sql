CREATE TABLE [dbo].[tTmpPadronClientes] (
  ...
  [EsNuevaGeneracionCodigo] [bit] NULL,
...
CREATE INDEX [IX_tTmpPadronClientes]
  ON [dbo].[tTmpPadronClientes] ([CodUsuario])
  WITH (PAD_INDEX = ON, FILLFACTOR = 80)
  ON [PRIMARY]
GO

CREATE INDEX [IX_tTmpPadronClientes_1]
  ON [dbo].[tTmpPadronClientes] ([CodDocIden])
  WITH (PAD_INDEX = ON, FILLFACTOR = 80)
  ON [PRIMARY]
GO

CREATE INDEX [IX_tTmpPadronClientes_2]
  ON [dbo].[tTmpPadronClientes] ([DI])
  WITH (PAD_INDEX = ON, FILLFACTOR = 80)
  ON [PRIMARY]
GO