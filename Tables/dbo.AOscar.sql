CREATE TABLE [dbo].[AOscar] (
  ...
  [TotalCastigada] AS (((((((((isnull([CapitalCastigado],(0))+isnull([InteresCastigadoVig],(0)))+isnull([InteresCastigadoVen],(0)))+isnull([InteresCastigadoOrd],(0)))+isnull([MoratorioCastigadoVig],(0)))+isnull([MoratorioCastigadoVen],(0)))+isnull([MoratorioCastigadoOrd],(0)))+isnull([MoraCastigada],(0)))+isnull([OtrosCargosCastigado],(0)))+isnull([ImpuestosCastigado],(0))),
  ...
  [TotalCierre] AS (((((((((isnull([CapitalCierre],(0))+isnull([InteresCierreVig],(0)))+isnull([InteresCierreVen],(0)))+isnull([InteresCierreOrd],(0)))+isnull([MoratorioCierreVig],(0)))+isnull([MoratorioCierreVen],(0)))+isnull([MoratorioCierreOrd],(0)))+isnull([MoraCierre],(0)))+isnull([OtrosCargosCierre],(0)))+isnull([ImpuestosCierre],(0))),
  ...
  [TotalActual] AS (((((((((isnull([CapitalActual],(0))+isnull([InteresActualVig],(0)))+isnull([InteresActualVen],(0)))+isnull([InteresActualOrd],(0)))+isnull([MoratorioActualVig],(0)))+isnull([MoratorioActualVen],(0)))+isnull([MoratorioActualOrd],(0)))+isnull([MoraActual],(0)))+isnull([OtrosCargosActual],(0)))+isnull([ImpuestosActual],(0))),
  ...
  [TotalPago] AS (((((isnull([CapitalPago],(0))+isnull([InteresPago],(0)))+isnull([MoratorioPago],(0)))+isnull([MoraPago],(0)))+isnull([OtrosCargosPago],(0)))+isnull([ImpuestosPago],(0))),
