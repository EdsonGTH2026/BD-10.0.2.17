...
GO
CREATE VIEW [dbo].[vINTFCuentaVr13]
AS
...
MOP as FormaPagoMOP,
DiasAtraso as DiasVencimiento,   --opcional
PlazoMeses,   
MontoDesembolso as MontoCreditoOriginacion,  --opcional
' ' as CorreoElectronicoConsumidor  --opcional
FROM         (SELECT     CodPrestamo, CodUsuario, ClaveUsuario, NombreUsuario, Responsabilidad, TipoCuenta, TipoContrato, UnidadMonetaria, ImporteAvaluo, 
                       ...
                       FROM          FinamigoConsolidado.dbo.tCsBuroxTblReICueVr13) Datos
