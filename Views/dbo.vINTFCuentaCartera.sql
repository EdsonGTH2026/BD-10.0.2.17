...
CREATE VIEW [dbo].[vINTFCuentaCartera]
AS
SELECT     VISTA.CodPrestamo, VISTA.CodUsuario, dbo.vINTFCabecera.ClaveUsuario, dbo.vINTFCabecera.NombreUsuario, 
		...
		WHEN substring(tCscartera.codprestamo,5, 3) = '303' THEN '01'  
...
FROM         (SELECT     CodPrestamo, Round(SUM(MontoCuota), 0) AS MontoPagar
                      ...
                      tCsPadronPlanCuotas.CodPrestamo, tCsPadronPlanCuotas.CodUsuario, tCsPadronPlanCuotas.NumeroPlan, tCsPadronPlanCuotas.SecCuota, 
			CASE WHEN substring(tCsPadronPlanCuotas.codprestamo, 5, 3) = '303' THEN '01' ELSE dbo.tCsBuroMOP.MOP END MOP
FROM         tCsPadronPlanCuotas with(nolock) INNER JOIN
                      ...
                      vINTFNombreCartera VISTA LEFT OUTER JOIN
